...
public class AlienMerchantEntity extends Animal implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public AlienMerchantEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createMobAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, 1.0f).build();
    }
